...
> 本文件位于 `zh-CN/00_master/`，描述的是**上级语言目录 `zh-CN/`**（以简体中文为目标语言的整套术语库）。
> 语言级说明见 `../README.md`，游戏级总说明见 `../../README.md`。

本语言目录是**以 `zh-CN` 为目标语言**的术语库：每一条都是「其他语言词条 → 简体中文」的对照，
共 **12292** 条词条、**46279** 行对照（`tgt_lng` 列固定为 `zh-CN`）。
